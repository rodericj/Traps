...
urlpatterns += patterns('',
    ...
    (r'^Login/', 'traps_app.views.Login'),
    (r'^Logout/', 'traps_app.views.Logout'),
    (r'^FindNearby/', 'traps_app.views.FindNearby'),
    (r'^SetTrap/(?P<vid>\d+)/(?P<iid>\d+)/(?P<uid>\d+)/', 'traps_app.views.SetTrap'),
    (r'^GetUserHistory/', 'traps_app.views.GetUserHistory'),
    (r'^GetUserDropHistory/', 'traps_app.views.GetUserDropHistory'),
    (r'^GetVenue/(?P<vid>\d+)/', 'traps_app.views.GetVenue'),
    (r'^GetUserProfile/(?P<uid>\d*)/?', 'traps_app.views.GetUserProfile'),
    (r'^SearchVenue/(?P<vid>\d+)/', 'traps_app.views.SearchVenue'),
