...
tutorial3 = "Great news. You found a Golden Egg of Destiny and an old banana peel.  Would you like to set a trap here for the next person who tries to search here?  (you should, just to keep it interesting"
