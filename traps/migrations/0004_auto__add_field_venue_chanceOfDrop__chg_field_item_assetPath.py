...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Venue.chanceOfDrop'
        db.add_column('traps_venue', 'chanceOfDrop', self.gf('django.db.models.fields.FloatField')(default=0.10000000000000001), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Venue.chanceOfDrop'
        db.delete_column('traps_venue', 'chanceOfDrop')
