...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Venue', fields ['foursquareid']
        db.create_unique('traps_venue', ['foursquareid'])

        # Changing field 'Item.assetPath'
        db.alter_column('traps_item', 'assetPath', self.gf('django.db.models.fields.FilePathField')(path='/home/rodericj/webapps/trap_media/images/', max_length=100))
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'Venue', fields ['foursquareid']
        db.delete_unique('traps_venue', ['foursquareid'])

        # Changing field 'Item.assetPath'
        db.alter_column('traps_item', 'assetPath', self.gf('django.db.models.fields.FilePathField')(path='/Users/roderic/dev/Traps/site_media/images/', max_length=100))
    ...
    models = {
        ...
        'traps.item': {
            ...
            'assetPath': ('django.db.models.fields.FilePathField', [], {'path': "'/home/rodericj/webapps/trap_media/images/'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'traps.trapsuser': {
            ...
            'level': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'photo': ('django.db.models.fields.FilePathField', [], {'path': "'images/avatars'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'traps.venue': {
            ...
            'chanceOfDrop': ('django.db.models.fields.FloatField', [], {'default': '0.10000000000000001'}),
            ...
            'foursquareid': ('django.db.models.fields.IntegerField', [], {'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
